...
TL;DR: A survey of AI-driven trailer generation documenting a shift from heuristic extraction to generative synthesis using LLMs, diffusion, and foundation models; introduces a taxonomy and analyzes architectures, economics, and ethics to chart a path toward controllable, semantically reconstructed trailers.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations of extractive, heuristic-based trailer methods and harness generative AI to produce coherent, emotionally resonant narratives at scale, leveraging foundation models and multimodal models.

Method: Technical literature review and synthesis. The authors trace architectural evolution (GCNs -> Trailer Generation Transformers), assess end-to-end pipelines (LLM orchestration), and evaluate generative, text-to-video foundation models. They propose a taxonomy and discuss economic and ethical implications of high-fidelity neural synthesis.

Result: A new AI-driven trailer generation taxonomy is proposed, highlighting a shift toward controllable generative editing and semantic reconstruction, and outlining an architectural progression (from GCNs to TGT) and system-level considerations (LLM pipelines, diffusion-based synthesis).

Conclusion: Future promotional video systems will move beyond extractive selection toward controllable, semantically driven generation, demanding attention to efficiency, governance, and ethical aspects while leveraging foundation-model-enabled trailer creation.
...
TL;DR: A lightweight representation-consistency pruning framework (RCP) for LVLMs that prunes visual tokens with monotonic masks and uses a delayed repair adapter, achieving substantial token and FLOP reductions with minimal accuracy loss.


<details>
  <summary>Details</summary>
Motivation: LVLM inference costs scale with visual token count; irreversible token pruning causes distribution shift from the pre-trained full-token regime, leading to performance degradation. A method is needed to prune tokens while preserving distributional consistency.

Method: Introduce a cross-attention pruner that uses the LLM's intrinsic attention as a baseline to predict cumulative masks, ensuring monotonic token reduction across layers. Add a delayed repair adapter (DRA) that caches the essence of pruned tokens and modulates answer-generation tokens via FiLM. Employ a repair loss that aligns the first- and second-order statistics of pruned representations with a full-token teacher.

Result: RCP can prune up to 88.9% of visual tokens and reduce FLOPs by up to 85.7% with only a marginal accuracy drop, outperforming prior methods that avoid fine-tuning the base model on multiple LVLM benchmarks.

Conclusion: RCP enables efficient LVLM inference by training lightweight plug-ins and allowing physical token discarding at inference; it achieves strong efficiency gains with minimal performance loss across benchmarks.
...
TL;DR: Video-MME-v2 is a rigorous, multi-level benchmark for robust and faithful video understanding, featuring a progressive tri-level hierarchy and a group-based non-linear evaluation, built with extensive human annotation to reveal real-model capabilities and bottlenecks.


<details>
  <summary>Details</summary>
Motivation: Current video benchmarks saturate with inflated scores that do not reflect real-world robustness or faithful reasoning. There is a need for a benchmark that tests multi-point visual aggregation, temporal modeling, and complex multimodal reasoning, while penalizing guesswork and rewarding valid, well-supported conclusions.

Method: Introduce a progressive tri-level hierarchy of video comprehension tasks (visual aggregation, temporal dynamics, multimodal reasoning). Adopt a group-based non-linear evaluation to enforce consistency and reasoning coherence. Build Video-MME-v2 via a controlled annotation pipeline with 12 annotators and 50 reviewers, totaling 3,300 human-hours and up to 5 rounds of quality assurance.

Result: Experiments show a substantial gap between state-of-the-art Gemini-3-Pro and human experts. They identify a hierarchical bottleneck where visual aggregation and temporal modeling errors propagate to high-level reasoning. Think­ing-based reasoning relies on textual cues, improving with subtitles but sometimes degrading in purely visual settings.

Conclusion: Video-MME-v2 serves as a demanding new testbed for the development of next-generation video multi-modal large language models, pushing models toward robust visual ingestion, temporal dynamics, and principled multimodal reasoning rather than guesswork.
...
TL;DR: Introduces ID-Sim, a feed-forward identity-sensitivity metric for image tasks, built with curated real and synthetic data, evaluated on a unified human-alignment benchmark.


<details>
  <summary>Details</summary>
Motivation: Humans show selective sensitivity to identities; vision models struggle to match this capability; there is a lack of identity-focused evaluation metrics for tasks like personalized image generation; a metric that reflects human perception is needed.

Method: Develop ID-Sim as a feed-forward metric; train on a high-quality, diverse real-world image dataset augmented with generative synthetic data that provide controlled identity and contextual variations; construct a unified evaluation benchmark to measure consistency with human annotations across identity-focused recognition, retrieval, and generative tasks.

Result: Not specified in the abstract; the paper outlines dataset curation and a benchmarking evaluation plan without providing quantitative results.

Conclusion: Proposes ID-Sim and a unified benchmark to assess alignment with human judgments in identity-focused tasks, aiming to advance identity-aware vision systems.
...
### [43] [Action Images: End-to-End Policy Learning via Multiview Video Generation](https://arxiv.org/abs/2604.06168)
...
### [75] [Learn to Rank: Visual Attribution by Learning Importance Ranking](https://arxiv.org/abs/2604.05819)
...
### [77] [Neural Network Pruning via QUBO Optimization](https://arxiv.org/abs/2604.05856)
...
### [79] [Multi-Modal Landslide Detection from Sentinel-1 SAR and Sentinel-2 Optical Imagery Using Multi-Encoder Vision Transformers and Ensemble Learning](https://arxiv.org/abs/2604.05959)
*Ioannis Nasios*
...
### [83] [HaloProbe: Bayesian Detection and Mitigation of Object Hallucinations in Vision-Language Models](https://arxiv.org/abs/2604.06165)
...
### [84] [On the Robustness of Diffusion-Based Image Compression to Bit-Flip Errors](https://arxiv.org/abs/2604.05743)
...
### [85] [SVC 2026: the Second Multimodal Deception Detection Challenge and the First Domain Generalized Remote Physiological Measurement Challenge](https://arxiv.org/abs/2604.05748)
...
### [87] [Beyond the Beep: Scalable Collision Anticipation and Real-Time Explainability with BADAS-2.0](https://arxiv.org/abs/2604.05767)
...
### [88] [PDMP: Rethinking Balanced Multimodal Learning via Performance-Dominant Modality Prioritization](https://arxiv.org/abs/2604.05773)
...
### [89] [Sparsity-Aware Voxel Attention and Foreground Modulation for 3D Semantic Scene Completion](https://arxiv.org/abs/2604.05780)
...
### [90] [RHVI-FDD: A Hierarchical Decoupling Framework for Low-Light Image Enhancement](https://arxiv.org/abs/2604.05781)
...
### [91] [Sparse Gain Radio Map Reconstruction With Geometry Priors and Uncertainty-Guided Measurement Selection](https://arxiv.org/abs/2604.05788)
...
### [92] [EfficientMonoHair: Fast Strand-Level Reconstruction from Monocular Video via Multi-View Direction Fusion](https://arxiv.org/abs/2604.05794)
...
TL;DR: A study on detecting regime switches in shared-workspace manipulation; introduces UA-TOM, a lightweight belief-tracking module that augments VLA backbones with selective state-space dynamics, causal attention, and prediction-error signals; achieves high detection performance with low latency and cross-domain robustness, reducing post-switch collisions in ManiSkill by 52% and showing complementary roles in Overcooked.


<details>
  <summary>Details</summary>
Motivation: Robots in shared workspaces must safely coordinate with agents whose behavior can change during tasks. Detecting regime changes quickly and reliably is crucial to prevent unsafe actions when policy assumptions become outdated.

Method: Evaluate ten detection methods across five random seeds in ManiSkill shared-workspace manipulation tasks. Propose UA-TOM, a lightweight belief-tracking module that augments frozen vision-language-action (VLA) backbones with selective state-space dynamics, causal attention, and prediction-error signals. Assess performance across five seeds and 1,200 episodes. Extend to cross-domain experiments in Overcooked to study the roles of causal attention and prediction-error signals. Measure detection rate, close-range detection time, and inference overhead.

Result: Enabling detection reduces post-switch collisions by 52%. UA-TOM achieves the highest detection rate among unassisted methods (85.7% at ±3 steps) and the lowest close-range time (4.8 steps), outperforming an Oracle (5.3 steps). Hidden-state update magnitude increases by 17x at regime switches and decays over ~10 timesteps; discretization step converges to Delta_t ≈ 0.78. In Overcooked, causal attention and prediction-error signals show complementary roles. UA-TOM adds 7.4 ms inference overhead (14.8% of a 50 ms control budget), enabling reliable regime-switch detection without modifying the base policy.

Conclusion: UA-TOM enables reliable regime-switch detection with minimal modification to the base policy and demonstrates robust performance under non-stationarity in ManiSkill, with transferable benefits to cross-domain tasks like Overcooked.
...
TL;DR: Survey and taxonomy of learning control interfaces for robotic manipulation from non-action-annotated video, introducing three families of interfaces and analyzing control-integration properties to identify robotics integration as the key bottleneck and future directions.


<details>
  <summary>Details</summary>
Motivation: To overcome the challenge of translating temporal structure in video into reliable robotic control without action labels, recognizing the gaps due to differences in embodiment, viewpoint, and physical constraints between video data and robot experience.

Method: Proposes an interface-centric taxonomy organized by where the video-to-control interface is constructed and what control properties it enables. Identifies three families: direct video--action policies (interface implicit), latent-action methods (use a compact learned intermediate), and explicit visual interfaces (predict interpretable targets). For each family, analyzes loop closure, verifiability, and failure modes.

Result: Cross-family synthesis highlights that the robotics integration layer is the most pressing open challenge, i.e., connecting video-derived predictions to dependable robot behavior. The paper outlines research directions aimed at closing this integration gap.

Conclusion: The survey emphasizes open challenges in robotics integration when using video-derived interfaces and provides directions for future work to bridge the gap between video-based interfaces and reliable robotic control.
...
TL;DR: COMB is a compact, open-source modular robotics platform for in-hive experiments, integrating an XY stage, Movable Access Window, and interchangeable payloads, validated via waggle-tracking, comb mosaics, and wing-actuator spectroscopy; demonstrated with three modules.


<details>
  <summary>Details</summary>
Motivation: Robotic access to real honeybee colonies requires operation in constrained spaces, tolerance to hive fouling, and ability to sense and actuate without frequent hardware redesign.

Method: Hardware and software design of COMB, integration of XY stage, MAW, payload modules, and embedded control; three payloads (biomimetic dance/signaling, close-range comb scanner, electromagnetic wing actuator); evaluation methods: waggle trajectory tracking, multi-image stitching, video spectral analysis.

Result: Demonstrates repeatable trajectory execution, repeatable comb mosaics, spectral analysis; positions COMB as a reusable general platform and successor to prior task-specific systems.

Conclusion: COMB provides a compact, generalized, open-source platform enabling controlled in-hive sensing and actuation for in-hive experiments, with modularity and reuse.
...
TL;DR: A survey of sensor-based planning/control for UUVs focusing on reactive local planning, comparing decoupled vs coupled architectures, and evaluating PID, MPC, and invariant-set controllers with tradeoffs; offers taxonomy and guidance for adaptive navigation.


<details>
  <summary>Details</summary>
Motivation: Underwater environments cause GNSS loss, low-bandwidth/high-latency communications, noisy sensors, and dynamic conditions, necessitating real-time localization, obstacle avoidance, and on-the-fly re-planning for autonomous UUVs.

Method: Literature survey categorized into decoupled and coupled planning/control architectures; comparative analysis of control methods (PID, MPC, invariant-set) and emphasis on adaptive local planning within integrated planning frameworks.

Result: Key findings stress trade-offs: PID is simple but lacks predictive capability; MPC provides path optimization but is computationally intensive; invariant-set controllers ensure safety but may limit agility, especially in confined spaces; coupled architectures enable tighter feedback and responsiveness; the work provides a taxonomy and guidance for adaptive local planning in UUV autonomy.

Conclusion: The study offers a taxonomy of sensor-based planning–control architectures, underscores the role of adaptive local planning, and outlines directions for integrated planning–control research to enhance robust autonomous navigation of UUVs in uncertain underwater environments.
...
TL;DR: StarVLA is an open-source, modular VLA framework with interchangeable backbones (VLMs and world models), reusable multimodal training strategies, and a unified benchmark suite, achieving competitive results with simple recipes and improving reproducibility.


<details>
  <summary>Details</summary>
Motivation: VLA research is fragmented across incompatible architectures, codebases, and evaluation protocols, hindering principled comparison and reproducibility.

Method: 1) A modular backbone–action head design that allows swapping VLM backbones (e.g., Qwen-VL) and world-model backbones (e.g., Cosmos) with various action-decoding paradigms; 2) reusable training strategies such as cross-embodiment learning and multimodal co-training; 3) a unified evaluation interface integrating major benchmarks (LIBERO, SimplerEnv, RoboTwin 2.0, RoboCasa-GR1, BEHAVIOR-1K) and support for simulation and real-robot deployment.

Result: StarVLA ships simple, reproducible single-benchmark training recipes that match or surpass prior methods on multiple benchmarks across both VLM and world-model backbones; it is a comprehensive, open-source framework.

Conclusion: StarVLA lowers barriers to reproducing existing methods and prototyping new VLA approaches; it is actively maintained and expanding, with code and docs at the provided GitHub repository.
...
TL;DR: GaussFly decouples representation learning from policy optimization in monocular AAV visuomotor control via a real-to-sim-to-real pipeline: 3D Gaussian Splatting for realistic scene reconstruction and contrastive learning to derive compact latent features, enabling sample-efficient, robust zero-shot sim-to-real transfer.


<details>
  <summary>Details</summary>
Motivation: End-to-end RGB policies for aerial visuomotor tasks suffer from poor sample efficiency and large sim-to-real gaps due to visual domain shifts; a pipeline that separates representation learning from policy optimization and creates photorealistic simulated training environments can improve transferability.

Method: 1) Real-to-sim: reconstruct training scenes with 3D Gaussian Splatting (3DGS) and geometric constraints. 2) Sim-to-real: render photorealistic images in the simulated scenes and apply contrastive representation learning to obtain compact, noise-robust latent features. 3) Use a pre-trained encoder to provide low-dimensional features to the visuomotor policy, reducing computation and increasing robustness to visual noise.

Result: In both simulation and real-world experiments, GaussFly achieves superior sample efficiency and higher asymptotic performance compared with baselines, and enables robust zero-shot transfer to unseen real environments with complex textures, effectively bridging the sim-to-real gap.

Conclusion: Decoupling representation learning from policy optimization in a real-to-sim-to-real framework—leveraging 3DGS-based scene reconstruction and contrastive latent features—yields improved sample efficiency, robustness to visual noise, and zero-shot transfer for monocular AAV visuomotor control.
...
TL;DR: Bilinear MPC for a tendon-driven steerable stylet integrated with a standard brachytherapy needle; shows feasible fixed- and moving-target tracking in simulations and tissue phantoms, with sub-2 mm open-loop errors and sub-2 mm closed-loop errors, but directional bending errors up to ~8 mm; calibration/sensing limitations remain.


<details>
  <summary>Details</summary>
Motivation: Enable curved needle trajectories during interstitial brachytherapy using commercially available needles; existing models target custom designs and are not readily transferable; require a control framework compatible with standard clinical hardware.

Method: Formulate a geometric bilinear model with three virtual inputs (insertion speed and two bending rates) mapped to actual tendon tensions and insertion actuation; apply bilinear MPC; validate via simulations and physical tissue-mimicking phantom with image-based tip tracking.

Result: Open-loop estimation error <2 mm (≈3% of inserted length); closed-loop fixed-target tracking error down to 1.45 mm (≈1.7%); some bending directions exhibit larger errors up to 8.3 mm (≈7.8%).

Conclusion: Demonstrates feasibility of fixed-target positioning and moving-target trajectory tracking for clinically compatible steerable brachytherapy systems; highlights calibration and sensing as key areas for improvement.
...
TL;DR: Language-driven evaluation for robotic manipulation via RoboPlayground; crowd-authored, executable task specs in a structured domain reveal generalization gaps and scalable task diversity.


<details>
  <summary>Details</summary>
Motivation: Fixed expert-authored benchmarks restrict evaluation and obscure how policies respond to user-intent variations; need executable, language-described task families in structured physical domains.

Method: Introduce RoboPlayground; compile natural-language instructions into executable task specifications with assets, initialization distributions, and success predicates; instantiate in block manipulation; conduct a user study comparing language interface to code-based baselines; evaluate learned policies on language-defined task families; analyze generalization and diversity scalability.

Result: Language-based interface reduces cognitive workload and is easier to use; evaluation on language-defined task families uncovers generalization failures not seen in fixed benchmarks; task diversity scales with contributor diversity rather than mere task count.

Conclusion: Language-driven evaluation enables richer, scalable manipulation policy evaluation; crowdsourced task authorship expands the evaluation space, facilitating continuous growth of evaluation benchmarks.
...
TL;DR: A compact deployable actuator enables reversible scale and stiffness changes via folding and zipping flexible 3D-printed strips into square-section beams; demonstrated in a four-module adaptive walking robot.


<details>
  <summary>Details</summary>
Motivation: Address the need for scalable, reconfigurable shape-changing mechanisms that are easy to fabricate, reconfigure, and translate across applications.

Method: Compound folding and zipping of flexible 3D-printed plastic strips to form square-section deployable beams, enabling smooth transitions between compact (flexible) and expanded (quasi-rigid) states; modules can be combined into larger assemblies.

Result: The actuator supports smooth, continuous transitions between states; mechanical performance was characterized and validated in a four-module adaptive walking robot.

Conclusion: The approach offers a scalable, modular path to shape-shifting systems with potential across robotics and adaptable structures, demonstrated here in a modular walking robot.
...
TL;DR: Proposes Pramana, a Navya-Nyaya–inspired epistemic framework to ground LLM reasoning; demonstrates 100% semantic correctness on Nyaya-based tasks after fine-tuning; open-source datasets/models; robust to partial format adherence; small task scope; broader validation needed.


<details>
  <summary>Details</summary>
Motivation: Address brittleness and hallucination in LLMs by grounding reasoning in traceable epistemic methodology rather than generic chain-of-thought; current models rely on brittle pattern-matching and lack structured justification.

Method: Fine-tune Llama 3.2-3B and DeepSeek-R1-Distill-Llama-8B on 55 Nyaya-structured logical problems (constraint satisfaction, Boolean SAT, multi-step deduction). Implement Navya-Nyaya’s six-phase reasoning (SAMSHAYA, PRAMANA, PANCHA AVAYAVA, TARKA, HETVABHASA, NIRNAYA); evaluate semantic correctness on held-out data; perform ablation studies on format prompting and temperature; release models/datasets on Hugging Face.

Result: Stage 1 achieves 100% semantic correctness on held-out evaluation despite only ~40% strict format adherence, indicating models internalize reasoning content even with imperfect enforcement. Ablation shows format prompts and temperature critically affect performance, with optimal configurations varying by stage.

Conclusion: Navya-Nyaya–inspired epistemic methodology provides cognitive scaffolding missing in standard reasoning approaches, enabling grounded, verifiable inference. The work offers open-source resources to advance epistemic frameworks for AI reasoning; further validation on broader tasks and comparisons with existing prompting strategies are needed.
...
TL;DR: Proposes an operational framework for metacognition as state-transforming operations with probabilistic readouts, demonstrating that order effects imply genuine non-commutativity beyond classical latent-variable models. Uses a 3D rotation model to show violations of classical non-invasive constraints and outlines a behavioral paradigm for empirical testing, without invoking quantum substrates.


<details>
  <summary>Details</summary>
Motivation: To distinguish classical sequential state changes from deeper structural non-commutativity in metacognitive evaluations, and to determine whether order effects require non-classical explanations.

Method: Model metacognitive evaluations as state-transforming operations on an internal state space with probabilistic readouts; show that order dependence cannot be faithfully represented by Boolean commutativity; introduce counterfactual definiteness and evaluation non-invasiveness as assumptions; derive testable constraints on pairwise sequential correlations; provide a 3D rotation model with numerical examples; propose a behavioral paradigm involving sequential confidence, error-likelihood, and feeling-of-knowing judgments.

Result: Order dependence defeats Boolean-commutative representation; under the two assumptions, violation of the derived constraints rules out classical non-invasive accounts and certifies genuine non-commutativity; a concrete 3D rotation model exhibits such violations; a behavioral experimental framework is outlined to test the predictions.

Conclusion: The framework is purely operational and algebraic, not tied to quantum substrates; it formalizes a notion of genuine non-commutativity in metacognitive processing and offers empirically testable predictions via a classical-appearing yet non-commutative model.
...
TL;DR: Introduces a mixed-domain proximity measure for information objects with sources from multiple origins; combines probabilistic treatment of quantitative features with possibility-based treatment of qualitative features; avoids feature value normalization; validates via axioms and presents variants.


<details>
  <summary>Details</summary>
Motivation: Data from independent sources are mapped to a common information resource with the goal of determining if they pertain to the same observation object, despite measurement errors and heterogeneous feature types.

Method: A unified proximity measure using probabilistic similarity for quantitative features and possibility-based similarity for qualitative features, assuming independence across sources, and avoiding normalization of feature values; provides multiple variants for groups of diverse features.

Result: Feasibility demonstrated by verifying the axioms required for a proximity/measure; the approach yields several variants and does not require feature value transformation to achieve comparability.

Conclusion: The approach offers a flexible, robust framework for assessing proximity of information objects with mixed feature types and noisy data; suitable for diverse applications; invites empirical validation and extensions (e.g., missing data, weighting, scalability).
...
TL;DR: A multi-turn, LLM-guided evolutionary approach (ReVEL) to automatically evolve robust, diverse heuristics for NP-hard optimization, using performance-profile grouping and reflective feedback that yields statistically significant improvements over strong baselines.


<details>
  <summary>Details</summary>
Motivation: Designing effective heuristics for NP-hard combinatorial optimization is difficult and expertise-intensive. One-shot LLM approaches tend to produce brittle solutions; however, iterative reasoning and structured feedback have potential to harness LLMs more effectively for heuristic design.

Method: Embed an LLM as an interactive, multi-turn reasoner inside an evolutionary algorithm (EA). Two mechanisms: (i) performance-profile grouping to cluster candidate heuristics into behaviorally coherent groups, providing compact, informative feedback to the LLM; (ii) multi-turn reflection where the LLM analyzes group-level behaviors and generates targeted refinements. An EA-based meta-controller selectively integrates refinements to balance exploration and exploitation.

Result: On standard combinatorial optimization benchmarks, ReVEL consistently yields heuristics that are more robust and diverse and achieves statistically significant improvements over strong baselines.

Conclusion: Multi-turn reasoning with structured grouping is a principled paradigm for automated heuristic design.
...
TL;DR: Expose algebraic structure in rule-combination problems, construct quotient spaces to collapse redundant representations, and optimize on reduced spaces; in conjunctive-rule systems this yields an isomorphism to the Boolean hypercube, enabling structure-aware search and improved optimization.


<details>
  <summary>Details</summary>
Motivation: Many combinatorial optimization problems hide algebraic structure that, once exposed, can shrink the search space and improve likelihood of finding the global optimum. A general framework to identify and exploit this structure can make search more efficient across diverse tasks.

Method: Propose a general framework: (i) identify algebraic structure; (ii) formalize operations; (iii) construct quotient spaces that collapse redundant representations; (iv) optimize directly over reduced spaces. Show that conjunctive rules form a monoid; use a characteristic-vector encoding; prove an isomorphism to {0,1}^n with bitwise OR (thus logical AND becomes OR in encoding); derive a quotient-space formulation that groups functionally equivalent rules and guides structure-aware search; implement and evaluate with quotient-space-aware genetic algorithms on real clinical data and synthetic benchmarks.

Result: Quotient-space-aware genetic algorithms recover the global optimum in about 48%–77% of runs, compared with 35%–37% for standard approaches, while maintaining diversity across equivalence classes.

Conclusion: Exposing and exploiting algebraic structure provides a simple, general route to more efficient combinatorial optimization across diverse rule-combination tasks.
...
### [166] [Uncertainty-Guided Latent Diagnostic Trajectory Learning for Sequential Clinical Diagnosis](https://arxiv.org/abs/2604.05116)
...
### [169] [IntentScore: Intent-Conditioned Action Evaluation for Computer-Use Agents](https://arxiv.org/abs/2604.05157)
...
### [170] [Bypassing the CSI Bottleneck: MARL-Driven Spatial Control for Reflector Arrays](https://arxiv.org/abs/2604.05162)
...
### [171] [Learning to Focus: CSI-Free Hierarchical MARL for Reconfigurable Reflectors](https://arxiv.org/abs/2604.05165)
...
### [175] [From Governance Norms to Enforceable Controls: A Layered Translation Method for Runtime Guardrails in Agentic AI](https://arxiv.org/abs/2604.05229)
*Christopher Koch*
...
### [176] [EAGLE: Edge-Aware Graph Learning for Proactive Delivery Delay Prediction in Smart Logistics Networks](https://arxiv.org/abs/2604.05254)
...
### [177] [Simulating the Evolution of Alignment and Values in Machine Intelligence](https://arxiv.org/abs/2604.05274)
...
### [178] [Pressure, What Pressure? Sycophancy Disentanglement in Language Models via Reward Decomposition](https://arxiv.org/abs/2604.05279)
...
### [179] [Graph of Skills: Dependency-Aware Structural Retrieval for Massive Agent Skills](https://arxiv.org/abs/2604.05333)
...
### [180] [TRACE: Capability-Targeted Agentic Training](https://arxiv.org/abs/2604.05336)
...
### [181] [Dynamic Agentic AI Expert Profiler System Architecture for Multidomain Intelligence Modeling](https://arxiv.org/abs/2604.05345)
...
### [182] [From Retinal Evidence to Safe Decisions: RETINA-SAFE and ECRT for Hallucination Risk Triage in Medical LLMs](https://arxiv.org/abs/2604.05348)
...
### [183] [ETR: Entropy Trend Reward for Efficient Chain-of-Thought Reasoning](https://arxiv.org/abs/2604.05355)
...
### [184] [LatentAudit: Real-Time White-Box Faithfulness Monitoring for Retrieval-Augmented Generation with Verifiable Deployment](https://arxiv.org/abs/2604.05358)
*Zhe Yu,Wenpeng Xing,Meng Han*
...
### [185] [TFRBench: A Reasoning Benchmark for Evaluating Forecasting Systems](https://arxiv.org/abs/2604.05364)
...
### [186] [LLM-as-Judge for Semantic Judging of Powerline Segmentation in UAV Inspection](https://arxiv.org/abs/2604.05371)
...
### [187] [Towards Effective In-context Cross-domain Knowledge Transfer via Domain-invariant-neurons-based Retrieval](https://arxiv.org/abs/2604.05383)
...
### [188] [Neural Assistive Impulses: Synthesizing Exaggerated Motions for Physics-based Characters](https://arxiv.org/abs/2604.05394)
...
### [189] [Reason Analogically via Cross-domain Prior Knowledge: An Empirical Study of Cross-domain Knowledge Transfer for In-Context Learning](https://arxiv.org/abs/2604.05396)
...
### [190] [CODESTRUCT: Code Agents over Structured Action Spaces](https://arxiv.org/abs/2604.05407)
...
### [191] [Multi-Agent Pathfinding with Non-Unit Integer Edge Costs via Enhanced Conflict-Based Search and Graph Discretization](https://arxiv.org/abs/2604.05416)
...
### [192] [Automated Auditing of Hospital Discharge Summaries for Care Transitions](https://arxiv.org/abs/2604.05435)
...
### [193] [Adaptive Serverless Resource Management via Slot-Survival Prediction and Event-Driven Lifecycle Control](https://arxiv.org/abs/2604.05465)
...
### [194] [OntoTKGE: Ontology-Enhanced Temporal Knowledge Graph Extrapolation](https://arxiv.org/abs/2604.05468)
...
### [195] [Can We Trust a Black-box LLM? LLM Untrustworthy Boundary Detection via Bias-Diffusion and Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2604.05483)
...
### [196] [Auditable Agents](https://arxiv.org/abs/2604.05485)
...
### [197] [SCMAPR: Self-Correcting Multi-Agent Prompt Refinement for Complex-Scenario Text-to-Video Generation](https://arxiv.org/abs/2604.05489)
...
### [198] [Thinking Diffusion: Penalize and Guide Visual-Grounded Reasoning in Diffusion Multimodal Language Models](https://arxiv.org/abs/2604.05497)
...
### [199] [OmniDiagram: Advancing Unified Diagram Code Generation via Visual Interrogation Reward](https://arxiv.org/abs/2604.05514)
...
### [200] [UniCreative: Unifying Long-form Logic and Short-form Sparkle via Reference-Free Reinforcement Learning](https://arxiv.org/abs/2604.05517)
...
### [201] [Market-Bench: Benchmarking Large Language Models on Economic and Trade Competition](https://arxiv.org/abs/2604.05523)
...
### [202] [ActivityEditor: Learning to Synthesize Physically Valid Human Mobility](https://arxiv.org/abs/2604.05529)
...
### [203] [Inventory of the 12 007 Low-Dimensional Pseudo-Boolean Landscapes Invariant to Rank, Translation, and Rotation](https://arxiv.org/abs/2604.05530)
...
### [204] [Experience Transfer for Multimodal LLM Agents in Minecraft Game](https://arxiv.org/abs/2604.05533)
...
### [205] [SignalClaw: LLM-Guided Evolutionary Synthesis of Interpretable Traffic Signal Control Skills](https://arxiv.org/abs/2604.05535)
...
### [206] [A canonical generalization of OBDD](https://arxiv.org/abs/2604.05537)
...
### [207] [From Large Language Model Predicates to Logic Tensor Networks: Neurosymbolic Offer Validation in Regulated Procurement](https://arxiv.org/abs/2604.05539)
...
### [213] [LUDOBENCH: Evaluating LLM Behavioural Decision-Making Through Spot-Based Board Game Scenarios in Ludo](https://arxiv.org/abs/2604.05681)
...
### [214] [QA-MoE: Towards a Continuous Reliability Spectrum with Quality-Aware Mixture of Experts for Robust Multimodal Sentiment Analysis](https://arxiv.org/abs/2604.05704)
...
### [215] [Can Large Language Models Reinvent Foundational Algorithms?](https://arxiv.org/abs/2604.05716)
...
### [216] [Contextual Control without Memory Growth in a Context-Switching Task](https://arxiv.org/abs/2604.03479)
*Song-Ju Kim*
...
### [217] [Emergent social transmission of model-based representations without inference](https://arxiv.org/abs/2604.05777)
...
### [218] [Hierarchical Reinforcement Learning with Augmented Step-Level Transitions for LLM Agents](https://arxiv.org/abs/2604.05808)
...
### [219] [Reciprocal Trust and Distrust in Artificial Intelligence Systems: The Hard Problem of Regulation](https://arxiv.org/abs/2604.05826)
*Martino Maggetti*
...
### [220] [Vision-Guided Iterative Refinement for Frontend Code Generation](https://arxiv.org/abs/2604.05839)
...
### [221] [Deep Researcher Agent: An Autonomous Framework for 24/7 Deep Learning Experimentation with Zero-Cost Monitoring](https://arxiv.org/abs/2604.05854)
*Xiangyue Zhang*
...
### [222] [When Do We Need LLMs? A Diagnostic for Language-Driven Bandits](https://arxiv.org/abs/2604.05859)
...
### [223] [Joint Knowledge Base Completion and Question Answering by Combining Large Language Models and Small Language Models](https://arxiv.org/abs/2604.05875)
...
### [224] [HybridKV: Hybrid KV Cache Compression for Efficient Multimodal Large Language Model Inference](https://arxiv.org/abs/2604.05887)
...
### [225] [Context-Value-Action Architecture for Value-Driven Large Language Model Agents](https://arxiv.org/abs/2604.05939)
...
### [226] [Towards Trustworthy Report Generation: A Deep Research Agent with Progressive Confidence Estimation and Calibration](https://arxiv.org/abs/2604.05952)
...
### [227] [Beyond Compromise: Pareto-Lenient Consensus for Efficient Multi-Preference LLM Alignment](https://arxiv.org/abs/2604.05965)
...
### [228] [Flowr -- Scaling Up Retail Supply Chain Operations Through Agentic AI in Large Scale Supermarket Chains](https://arxiv.org/abs/2604.05987)
...
### [229] [Epistemic Blinding: An Inference-Time Protocol for Auditing Prior Contamination in LLM-Assisted Analysis](https://arxiv.org/abs/2604.06013)
*Michael Cuccarese*
...
### [230] [How LLMs Follow Instructions: Skillful Coordination, Not a Universal Mechanism](https://arxiv.org/abs/2604.06015)
...
### [231] [Artificial Intelligence and the Structure of Mathematics](https://arxiv.org/abs/2604.06107)
...
### [232] [Claw-Eval: Toward Trustworthy Evaluation of Autonomous Agents](https://arxiv.org/abs/2604.06132)
...
### [233] [Selecting a Maximum Solow-Polasky Diversity Subset in General Metric Spaces Is NP-hard](https://arxiv.org/abs/2604.05495)
*Michael T. M. Emmerich,Ksenia Pereverdieva,André H. Deutz*

Main category: cs.CG

TL;DR: NP-hardness of selecting a fixed-size subset to maximize Solow--Polasky diversity, via a reduction from Independent Set using a two-distance metric; holds for every fixed theta0>0 (scaling fixes theta0 to 1); nonlinear objective due to matrix inversion; requires a dedicated monotonicity argument for the constructed distance matrices; links to continuity/monotonicity properties of diversity indicators.


<details>
  <summary>Details</summary>
Motivation: Clarify the computational limits of Solow--Polasky diversity (magnitude) as a subset selection objective and illuminate how nonlinearity from matrix inversion interacts with combinatorial hardness.

Method: Construct a metric with only two nonzero distances. Reduce Independent Set to the fixed-cardinality subset selection problem using the Solow--Polasky objective. Leverage the nonlinear, matrix-inversion-based objective to prove NP-hardness. Establish a strict-monotonicity property for the specific family of distance matrices used, rather than assuming it generally. Normalize by rescaling to fix theta0>0 (often theta0=1). Discuss connections to continuity and monotonicity of diversity indicators.

Result: Hardness result: the subset selection problem is NP-hard in general metric spaces. The hardness persists for all fixed kernel parameter theta0>0, and simplification to theta0=1 is possible by rescaling. The reduction is nontrivial due to the matrix-inversion-based objective and requires bespoke monotonicity analysis for the constructed distance matrices. The work also relates to continuity/monotonicity considerations for diversity indicators.

Conclusion: The Solow--Polasky diversity-based subset selection is computationally intractable in general, highlighting the need for heuristics or approximation schemes. The paper clarifies the role of nonlinearity (matrix inversion) in hardness and provides a rigorous monotonicity analysis for the constructed instances, with connections to broader properties of diversity indicators.
...
### [234] [Realizing Planar Linkages in Polygonal Domains](https://arxiv.org/abs/2604.05786)
*Thomas Depian,Carolina Haase,Martin Nöllenburg,André Schulz*

Main category: cs.CG

TL;DR: Hardness persists for planar realization of linkages even for structurally simple graphs and unit edge lengths within a polygonal domain; while general cases are NP-hard, some narrow instances are solvable in linear time.


<details>
  <summary>Details</summary>
Motivation: To map the boundary between tractable and intractable instances of the planar linkage realization problem, in the setting of constrained domains and prescribed vertex positions, and to place the problem in the framework of parameterized complexity.

Method: The authors study the decision problem for realizability in a fixed polygonal domain P, analyzing complexity with respect to the graph size |G| and with l ≡ 1. They prove XP-membership and W[1]-hardness for general linkages, reduce to NP-hardness for path graphs with endpoints fixed, and derive a linear-time algorithm for the special case of a 3-edge path in a convex P. Typical reductions from known hard problems and constructive algorithms are employed.

Result: - Realizability is in XP with respect to |G|, but W[1]-hard (and thus unlikely FPT) even when all edge lengths are unit and no vertex positions are fixed. 
- If G is a path with prescribed endpoints and l ≡ 1, the problem is NP-hard in general.
- There is a linear-time algorithm when G has exactly three edges and P is convex, with unit lengths.

Conclusion: The problem remains computationally challenging even for relatively simple linkages in constrained domains; only very restricted subcases yield efficient algorithms. The results chart the complexity landscape and motivate further study of parameterized and special-case tractability in linkage realization.
...
### [235] [A Theory-guided Weighted $L^2$ Loss for solving the BGK model via Physics-informed neural networks](https://arxiv.org/abs/2604.04971)
*Gyounghun Ko,Sung-Jun Son,Seung Yeon Cho,Myeong-Su Lee*

Main category: cs.LG

TL;DR: A velocity-weighted L2 loss for PINNs applied to the BGK model improves accuracy and guarantees convergence, addressing inadequacies of standard L2 loss in capturing macroscopic moments.


<details>
  <summary>Details</summary>
Motivation: Standard L2 loss in PINNs under the BGK kinetic model under-penalizes errors in high-velocity regions, leading to inaccurate macroscopic moments; a weighted loss can better enforce physical fidelity.

Method: Introduce a velocity-weighted L2 loss for PINNs solving the BGK equation; derive a stability estimate; prove convergence of the approximate solution under the weighted loss; compare with standard PINN on numerical benchmarks.

Result: Weighted PINN demonstrates superior accuracy and robustness across benchmarks compared to the standard PINN loss.

Conclusion: Velocity-weighted losses provide a principled route to enforce physically relevant quantities in kinetic equations; the approach can extend to other kinetic models and motivate further theory and experiments.
...
### [236] [Territory Paint Wars: Diagnosing and Mitigating Failure Modes in Competitive Multi-Agent PPO](https://arxiv.org/abs/2604.04983)
*Diyansha Singh*

Main category: cs.LG

TL;DR: Identifies five PPO self-play failure modes in a Unity MARL benchmark, uncovers competitive overfitting after fixes, and shows opponent mixing as a simple, effective mitigation to restore generalization; open-source benchmark provided.


<details>
  <summary>Details</summary>
Motivation: To understand why standard self-play often fails to generalize in competitive MARL and to establish reproducible benchmarks for diagnosing failure modes.

Method: Develop Territory Paint Wars in Unity, train PPO agents with self-play, perform controlled ablations to isolate implementation-level failure modes (reward-scale imbalance, missing terminal signal, ineffective long-horizon credit assignment, unnormalised observations, incorrect win detection). After fixes, detect competitive overfitting where self-play performance remains high but generalization collapses; propose opponent mixing (20% random opponent) to mitigate; validate across seeds; release open-source benchmark.

Result: Five implementation-level failure modes identified; correcting them reveals competitive overfitting where co-adaptation maintains self-play win rate but generalization drops from 73.5% to 21.6%. Opponent mixing restores generalization to 77.1% ±12.6% across 10 seeds, without population-based training. Benchmark is open-sourced for reproducibility.

Conclusion: Self-play metrics can be misleading; simple, low-cost interventions like opponent mixing can prevent competitive overfitting and yield robust generalization. The Territory Paint Wars benchmark provides a reproducible platform to study competitive MARL failure modes.
...
### [237] [Enhancing sample efficiency in reinforcement-learning-based flow control: replacing the critic with an adaptive reduced-order model](https://arxiv.org/abs/2604.04986)
*Zesheng Yao,Zhen-Hua Wan,Canjun Yang,Qingchao Xia,Mengqi Zhang*

Main category: cs.LG

TL;DR: Adaptive reduced-order-model (ROM) based reinforcement learning for active flow control improves sample efficiency by integrating a linear dynamical system and a neural ODE (NODE) to estimate gradients for controller optimization, with online ROM updates via operator inference and data-driven training; validated on Blasius boundary layer and flow past a square cylinder, showing performance gains with significantly less exploration data.


<details>
  <summary>Details</summary>
Motivation: Model-free deep reinforcement learning (DRL) suffers from poor sample efficiency in complex fluid dynamics control tasks. A data-efficient, model-assisted DRL approach could accelerate learning and reduce data requirements while maintaining performance.

Method: Construct a reduced-order model that combines a linear dynamical system (identified via operator inference) with a neural ODE to capture nonlinearity. The ROM is refined online with new data. Controller optimization is performed through differentiable simulation of the ROM, rather than conventional actor–critic architectures.

Result: On Blasius boundary layer, the method achieves near-DRL performance with minimal data, outperforming traditional linear designs. On flow past a square cylinder, it achieves superior drag reduction with substantially less exploration data than standard DRL.

Conclusion: The work enhances sample efficiency in model-free DRL for active flow control by embedding an adaptive ROM within the learning loop, establishing a foundation for more data-efficient, ROM-informed DRL controllers.
...
### [238] [Cactus: Accelerating Auto-Regressive Decoding with Constrained Acceptance Speculative Sampling](https://arxiv.org/abs/2604.04987)
*Yongchang Hao,Lili Mou*

Main category: cs.LG

TL;DR: Constrained Acceptance Speculative Sampling (Cactus) formalizes speculative sampling as a constrained optimization to permit controlled divergence from the verifier distribution, boosting token acceptance rates while preserving output quality; empirically effective across benchmarks.


<details>
  <summary>Details</summary>
Motivation: SpS enforces exact parity with the verifier, which is overly restrictive; TAS improves throughput but distorts the verifier distribution and may harm quality. A principled framework is needed to balance speed and fidelity.

Method: Formulate speculative sampling as a constrained optimization: maximize token acceptance from a draft model subject to a divergence constraint between the draft and verifier distributions (e.g., KL or total-variation). Derive the Cactus algorithm that enforces this constraint, enabling higher acceptance rates without exceeding a specified divergence bound. The approach accommodates various verifier distributions and sampling protocols (e.g., top-k, temperature).

Result: Empirical experiments across diverse benchmarks demonstrate that Cactus increases acceptance rates relative to strict SpS and mitigates the quality degradation seen with naive TAS by keeping divergence within predefined limits, yielding faster decoding with maintained output quality.

Conclusion: Cactus provides a tunable, theoretically grounded framework for speculative sampling that permits controlled divergence from the verifier while achieving higher throughput; the method is broadly applicable to different verifier models and sampling settings and improves robustness of speculative decoding.
...
### [239] [Prune-Quantize-Distill: An Ordered Pipeline for Efficient Neural Network Compression](https://arxiv.org/abs/2604.04988)
*Longsheng Zhou,Yu Shen*

Main category: cs.LG

TL;DR: An ordered pruning-INT8 QAT-KD pipeline targets measured latency rather than proxy metrics; INT8 QAT yields the main runtime gains, pruning serves as a preconditioner for robust low-precision optimization, and KD recovers accuracy within the sparse INT8 regime. The approach yields superior accuracy-size-latency trade-offs on CIFAR-10/100 with ResNet-18, WRN-28-10, and VGG-16-BN; stage order matters.


<details>
  <summary>Details</summary>
Motivation: Proxy metrics (parameter count, FLOPs) poorly predict wall-clock latency for compressed models. Unstructured sparsity can fail to speed up CPU execution due to irregular memory access and sparse kernel overhead. There is a need for a practical pipeline that optimizes for measured latency while maintaining accuracy.

Method: Apply an ordered three-stage pipeline: (1) unstructured pruning, (2) INT8 quantization-aware training (QAT), (3) knowledge distillation (KD). Evaluate with ablations on stage ordering (20/40/40 epoch splits) and compare against single techniques. Datasets and backbones: CIFAR-10/100; ResNet-18, WRN-28-10, VGG-16-BN.

Result: INT8 QAT provides the dominant runtime benefit; pruning mainly reduces capacity and improves robustness of subsequent low-precision optimization; KD, applied last, recovers accuracy within the constrained sparse INT8 regime without altering deployment. The ordered pipeline achieves a stronger accuracy-size-latency frontier than any single technique, with CPU latency 0.99–1.42 ms and competitive accuracy. Stage order is consequential, with the proposed ordering typically performing best among tested permutations.

Conclusion: Evaluating compression choices in the joint accuracy-size-latency space using measured runtime yields practical deployment guidance; the ordered pipeline is superior to individual techniques, and stage ordering matters.
...
### [240] [Learning-Based Multi-Criteria Decision Making Model for Sawmill Location Problems](https://arxiv.org/abs/2604.04996)
...
### [241] [El Nino Prediction Based on Weather Forecast and Geographical Time-series Data](https://arxiv.org/abs/2604.04998)
...
### [242] [PRIME: Prototype-Driven Multimodal Pretraining for Cancer Prognosis with Missing Modalities](https://arxiv.org/abs/2604.04999)
...
### [243] [Learning Stable Predictors from Weak Supervision under Distribution Shift](https://arxiv.org/abs/2604.05002)
...
### [244] [Energy-Based Dynamical Models for Neurocomputation, Learning, and Optimization](https://arxiv.org/abs/2604.05042)
...
### [245] [PCA-Driven Adaptive Sensor Triage for Edge AI Inference](https://arxiv.org/abs/2604.05045)
...
### [246] [Blind-Spot Mass: A Good-Turing Framework for Quantifying Deployment Coverage Risk in Machine Learning Systems](https://arxiv.org/abs/2604.05057)
...
### [247] [Dynamic Linear Coregionalization for Realistic Synthetic Multivariate Time Series](https://arxiv.org/abs/2604.05064)
...
### [248] [Towards Scaling Law Analysis For Spatiotemporal Weather Data](https://arxiv.org/abs/2604.05068)
...
### [249] [Hierarchical SVG Tokenization: Learning Compact Visual Programs for Scalable Vector Graphics Modeling](https://arxiv.org/abs/2604.05072)
...
### [250] [Feature-Aware Anisotropic Local Differential Privacy for Utility-Preserving Graph Representation Learning in Metal Additive Manufacturing](https://arxiv.org/abs/2604.05077)
...
### [251] [Vintix II: Decision Pre-Trained Transformer is a Scalable In-Context Reinforcement Learner](https://arxiv.org/abs/2604.05112)
...
### [252] [Reasoning Through Chess: How Reasoning Evolves from Data Through Fine-Tuning and Reinforcement Learning](https://arxiv.org/abs/2604.05134)
...
### [253] [Not All Turns Are Equally Hard: Adaptive Thinking Budgets For Efficient Multi-Turn Reasoning](https://arxiv.org/abs/2604.05164)
...
### [254] [General Multimodal Protein Design Enables DNA-Encoding of Chemistry](https://arxiv.org/abs/2604.05181)
...
### [255] [Cross-fitted Proximal Learning for Model-Based Reinforcement Learning](https://arxiv.org/abs/2604.05185)
...
### [257] [On the Geometry of Positional Encodings in Transformers](https://arxiv.org/abs/2604.05217)
...
### [258] [Curvature-Aware Optimization for High-Accuracy Physics-Informed Neural Networks](https://arxiv.org/abs/2604.05230)
...
### [260] [Jeffreys Flow: Robust Boltzmann Generators for Rare Event Sampling via Parallel Tempering Distillation](https://arxiv.org/abs/2604.05303)
...
### [261] [LLMs Should Express Uncertainty Explicitly](https://arxiv.org/abs/2604.05306)
...
### [262] [A Theoretical Framework for Statistical Evaluability of Generative Models](https://arxiv.org/abs/2604.05324)
...
### [263] [Cross-Machine Anomaly Detection Leveraging Pre-trained Time-series Model](https://arxiv.org/abs/2604.05335)
...
### [264] [LMI-Net: Linear Matrix Inequality--Constrained Neural Networks via Differentiable Projection Layers](https://arxiv.org/abs/2604.05374)
...
### [265] [Training Without Orthogonalization, Inference With SVD: A Gradient Analysis of Rotation Representations](https://arxiv.org/abs/2604.05414)
*Chris Choy*
...
### [266] [ALTO: Adaptive LoRA Tuning and Orchestration for Heterogeneous LoRA Training Workloads](https://arxiv.org/abs/2604.05426)
...
### [267] [Top-K Retrieval with Fixed-Size Linear-Attention Completion: Backbone- and KV-Format-Preserving Attention for KV-Cache Read Reduction](https://arxiv.org/abs/2604.05438)
...
### [268] [Reproducing AlphaZero on Tablut: Self-Play RL for an Asymmetric Board Game](https://arxiv.org/abs/2604.05476)
...
### [269] [Channel-wise Retrieval for Multivariate Time Series Forecasting](https://arxiv.org/abs/2604.05543)
...
### [270] [Same Graph, Different Likelihoods: Calibration of Autoregressive Graph Generators via Permutation-Equivalent Encodings](https://arxiv.org/abs/2604.05613)
...
### [271] [From Uniform to Learned Knots: A Study of Spline-Based Numerical Encodings for Tabular Deep Learning](https://arxiv.org/abs/2604.05635)
...
### [272] [Optimal-Transport-Guided Functional Flow Matching for Turbulent Field Generation in Hilbert Space](https://arxiv.org/abs/2604.05700)
...
### [273] [Controllable Image Generation with Composed Parallel Token Prediction](https://arxiv.org/abs/2604.05730)
...
### [274] [Graph Topology Information Enhanced Heterogeneous Graph Representation Learning](https://arxiv.org/abs/2604.05732)
...
### [275] [Bivariate Causal Discovery Using Rate-Distortion MDL: An Information Dimension Approach](https://arxiv.org/abs/2604.05829)
...
### [276] [Hidden in the Multiplicative Interaction: Uncovering Fragility in Multimodal Contrastive Learning](https://arxiv.org/abs/2604.05834)
...
### [277] [Expectation Maximization (EM) Converges for General Agnostic Mixtures](https://arxiv.org/abs/2604.05842)
*Avishek Ghosh*
...
### [278] [EEG-MFTNet: An Enhanced EEGNet Architecture with Multi-Scale Temporal Convolutions and Transformer Fusion for Cross-Session Motor Imagery Decoding](https://arxiv.org/abs/2604.05843)
...
### [279] [Modeling Patient Care Trajectories with Transformer Hawkes Processes](https://arxiv.org/abs/2604.05844)
...
### [280] [Weight-Informed Self-Explaining Clustering for Mixed-Type Tabular Data](https://arxiv.org/abs/2604.05857)
...
### [281] [ReLU Networks for Exact Generation of Similar Graphs](https://arxiv.org/abs/2604.05929)
...
### [282] [A Mixture of Experts Foundation Model for Scanning Electron Microscopy Image Analysis](https://arxiv.org/abs/2604.05960)
...
### [283] [On Dominant Manifolds in Reservoir Computing Networks](https://arxiv.org/abs/2604.05967)
...
### [284] [Data Distribution Valuation Using Generalized Bayesian Inference](https://arxiv.org/abs/2604.05993)
...
### [285] [Gated-SwinRMT: Unifying Swin Windowed Attention with Retentive Manhattan Decay via Input-Dependent Gating](https://arxiv.org/abs/2604.06014)
...
### [286] [PromptEvolver: Prompt Inversion through Evolutionary Optimization in Natural-Language Space](https://arxiv.org/abs/2604.06061)
...
### [287] [A machine learning framework for uncovering stochastic nonlinear dynamics from noisy data](https://arxiv.org/abs/2604.06081)
...
### [288] [Learning $\mathsf{AC}^0$ Under Graphical Models](https://arxiv.org/abs/2604.06109)
...
### [289] [Gym-Anything: Turn any Software into an Agent Environment](https://arxiv.org/abs/2604.06126)
...
### [290] [Toward Consistent World Models with Multi-Token Prediction and Latent Semantic Enhancement](https://arxiv.org/abs/2604.06155)
...
### [291] [Target Policy Optimization](https://arxiv.org/abs/2604.06159)
*Jean Kaddour*
...
### [292] [Topological Characterization of Churn Flow and Unsupervised Correction to the Wu Flow-Regime Map in Small-Diameter Vertical Pipes](https://arxiv.org/abs/2604.06167)
...
### [293] [In-Place Test-Time Training](https://arxiv.org/abs/2604.06169)
